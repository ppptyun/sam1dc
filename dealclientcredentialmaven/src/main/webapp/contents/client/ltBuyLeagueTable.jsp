...
<script src="js/contents/client/ltBuyLeagueTable.js" charset='utf-8'></script>
<script>
...
<body>
	<div class="dc_con_area" id="dc_con_list">
		...
		<!-- 2019.01.23 남웅주 --> 
			<select id="sel_actcdbizcd" name="sel_actcdbizcd">
				<option value="" selected>전체</option>
				<option value="100403-100502-1">인수자문-재무/전략자문</option>
				<option value="100403-100503-1">인수자문-회계자문</option>
				<option value="100402-100502-1">매각자문-재무/전략자문</option>
				<option value="100402-100503-1">매각자문-회계자문</option>
			</select>
		<!-- 2019.01.23 남웅주 -->
