 ...
 *
 */
public class DcAdminCommCodeDetailServiceWorker extends AbstractServiceWorker {

	public DcAdminCommCodeDetailServiceWorker(HttpServletRequest request, HttpServletResponse response, DBConnection connection) {
	...
	public Object process() throws Exception {
		...
		CommCodeDetailBean vo = new CommCodeDetailBean();
		try {
			vo = treeDAO.sqlSelectCommCodeDetail(parcd, itemcd);
		} catch (Exception e) {
			e.printStackTrace();
		}
