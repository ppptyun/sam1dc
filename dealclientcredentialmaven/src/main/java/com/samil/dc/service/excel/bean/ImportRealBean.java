...
public class ImportRealBean implements Serializable {
	
	private static final long serialVersionUID = -3598156170999251088L;

	private int row = 0;
	private boolean valid = true;
	private String conscd = Constants.Consult.REAL;
	...
	public ImportRealBean(int row, String refyearly, String prjtcd) {
		this.row = row;
	...
	public String toString() {
		return "ImportRealBean [row=" + row + ", conscd=" + conscd + ", refyearly=" + refyearly + ", yearly=" + yearly + ", prjtcd=" + prjtcd + ", prjtcd1=" + prjtcd1 + ", prjtcd2=" + prjtcd2 + ", prjtcd3=" + prjtcd3 + ", credtgtcd=" + credtgtcd + ", prjtnm=" + prjtnm + ", hqcd=" + hqcd + ", hqnm=" + hqnm + ", ptrempno=" + ptrempno + ", mgrempno=" + mgrempno + ", processnm=" + processnm + ", contdt=" + contdt + ", termidt=" + termidt + ", pdtcd=" + pdtcd + ", pdtnm=" + pdtnm + ", statuscd=" + statuscd + ", consdt=" + consdt + ", spadt=" + spadt + ", moudt=" + moudt + ", closdt=" + closdt + ", currcd=" + currcd + ", currnm=" + currnm + ", rate=" + rate + ", amt=" + amt + ", borddealcd=" + borddealcd + ", borddealnm=" + borddealnm + ", client=" + client + ", target=" + target + ", seller=" + seller + ", sellfinance=" + sellfinance + ", sellaudit=" + sellaudit + ", selllaw=" + selllaw + ", buyer=" + buyer + ", buyfinance=" + buyfinance + ", buyaudit=" + buyaudit + ", buylaw=" + buylaw + ", paycd=" + paycd + ", chamtw=" + chamtw + ", cisno=" + cisno + ", cisno1=" + cisno1 + ", cisno2=" + cisno2 + ", cisno3=" + cisno3 + "]";
	}
}
