...
<body>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/v1/selectbox_pwc.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/v1/pwc_ui.js"></script>
</body>
</html>