...
<head>
	...
	<link href="${pageContext.request.contextPath}/resources/css/v3/pwc_new.css?version=<fmt:formatDate value="${now}" pattern="yyyyMMddHHmmss" />" rel="stylesheet" type="text/css">
	<link href="${pageContext.request.contextPath}/resources/css/v3/pwc_mediaS.css?version=<fmt:formatDate value="${now}" pattern="yyyyMMddHHmmss" />" rel="stylesheet" type="text/css" media="(max-width:1600px)">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/v3/selectbox_pwc.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/v3/pwc_ui.js"></script>
