...
<div class="layCont">
	...
	<table class="tblForm tblD marT20">
		...
		<tbody>
			...
			<%-- <tr>
				...
				<th scope="row">QRP/QC/SPA/Fulcrum</th>
	...
	<span class="txtInfo"><b>예상 표준수익</b>: 직급별 표준단가를 적용한 표준보수입입니다. 단, TBD인 Fulcrum, SPA 는 SA Grade, QC 는 Director Grade를 가정하여 계산하였습니다. F-link 에서 적정 Grade로 조정하여 정확한 예상수익을 계산하시기를 권고드립니다. </span>
