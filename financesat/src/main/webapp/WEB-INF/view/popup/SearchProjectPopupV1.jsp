	...
	function onClickBtnOk(){
		...
		if(callback){
			callback({
				...
				chargPtr: prjtGridObj.getUserData(rid, 'chargptr'),
				chargPtrNm: prjtGridObj.getUserData(rid, 'chargptrNm'),
				chargPtrGradNm: prjtGridObj.getUserData(rid, 'chargptrGradNm'),
				chargMgr: prjtGridObj.getUserData(rid, 'chargmgr'),
				chargMgrNm: prjtGridObj.getUserData(rid, 'chargmgrNm'),
				chargMgrGradNm: prjtGridObj.getUserData(rid, 'chargmgrGradNm'),
