...
fetchData().done(function(prjtInfo){
	...
	new Vue({
		...
		methods:{
			...
			//========================================================================================
			//	[시작] 20220224 남웅주  사업연도 시작월을 선택시에 2022년도 이후이면 v4 버전으로 작성화면 이동
			//========================================================================================
			checkBizFrdt: function() {
				if(this.bizFrdt >= '2022-01'){
					Helper.MessageBox("2022년 1월 이후에 시작하는 회계연도의 대한 감사의 경우, 새로운 작성화면으로 이동합니다.");
					Helper.goPage("/pages/satcalc/v4/new");
				}			
			}
			//========================================================================================
			//	[종료] 20220224 남웅주  사업연도 시작월을 선택시에 2022년도 이후이면 v4 버전으로 작성화면 이동
			//========================================================================================			
		},
		watch:{
			bizFrdt: function(){
