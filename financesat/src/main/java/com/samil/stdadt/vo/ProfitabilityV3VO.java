...
public class ProfitabilityV3VO {
	...
	private double qrpBdgtTm;			// QC 예산시간
	private double qcBdgtTm;			// QC 예산시간
	...
	private long rateQrp;				// QRP 시간당 단가
	private long rateQc;				// QC 시간당 단가
	private long rateNewStf;			// New Staff 시간당 단가
	private long rateOther;				// Other 시간당 단가
	private long rateRa;				// RA 시간당 단가
	private long rateFlcm;				// Fulcrum 시간당 단가
	...
	public void calculate() {
		this.totBdgtFee = (this.bdgtP * this.rateP) 
						...
						+ (this.qcBdgtTm * this.rateQc)
						+ (this.qrpBdgtTm * this.rateQrp)
						+ (this.newStfBdgtTm * this.rateNewStf)
						+ (this.raBdgtTm * this.rateRa)
						+ (this.flcmBdgtTm * this.rateFlcm)
						+ (this.otherBdgtTm * this.rateOther);
		
		this.feeDiff = this.totCntrtFee - this.totBdgtFee;
		
		this.realization = this.totBdgtFee == 0?0:(this.totCntrtFee / this.totBdgtFee * 100); 
		
		this.etcBdgtTm = this.qrpBdgtTm +  this.qcBdgtTm + this.flcmBdgtTm + this.raBdgtTm + this.otherBdgtTm;
	}
	...
	public double getQcBdgtTm() {
		return qcBdgtTm;
	}

	public long getRateQc() {
		return rateQc;
	}

	public long getRateNewStf() {
		return rateNewStf;
	}

	public long getRateOther() {
		return rateOther;
	}

	public long getRateRa() {
		return rateRa;
	}

	public long getRateFlcm() {
		return rateFlcm;
	}

	public void setQcBdgtTm(double qcBdgtTm) {
		this.qcBdgtTm = qcBdgtTm;
	}

	public void setRateQc(long rateQc) {
		this.rateQc = rateQc;
	}

	public void setRateNewStf(long rateNewStf) {
		this.rateNewStf = rateNewStf;
	}

	public void setRateOther(long rateOther) {
		this.rateOther = rateOther;
	}

	public void setRateRa(long rateRa) {
		this.rateRa = rateRa;
	}

	public void setRateFlcm(long rateFlcm) {
		this.rateFlcm = rateFlcm;
	}
	...
	public double getQrpBdgtTm() {
		return qrpBdgtTm;
	}

	public void setQrpBdgtTm(double qrpBdgtTm) {
		this.qrpBdgtTm = qrpBdgtTm;
	}

	public long getRateQrp() {
		return rateQrp;
	}

	public void setRateQrp(long rateQrp) {
		this.rateQrp = rateQrp;
	}
}	
