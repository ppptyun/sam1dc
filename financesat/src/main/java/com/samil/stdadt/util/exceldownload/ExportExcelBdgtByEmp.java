...
public class ExportExcelBdgtByEmp extends AbstractExportExcel {
	
	int firstWeekIdx = 0;
	List<WeekVO> weeks;
	
	public ExportExcelBdgtByEmp(Map<String, Object> option) throws Exception {
		super(option);
	}
	public ExportExcelBdgtByEmp(String templateFilePath, String templateFileName, Map<String, Object> option) throws Exception {
