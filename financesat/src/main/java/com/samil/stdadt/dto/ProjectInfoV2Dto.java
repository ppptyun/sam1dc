...
public class ProjectInfoV2Dto {
	...
	private List<SubProjectV2Dto> subPrjt; // 합산 대상 프로젝트 정보
	...
	// 상하한(기준숙련도 기준) 영역
	//################################################################################
	private CamelMap minMaxYn;				// 상하한 적용 여부
	...
	public ProjectInfoV2Dto() {}
	public void init(ProjectInfoV2VO prjtInfo) throws Exception{
		//################################################################################
		// 데이터 메타정보
		//################################################################################
	...
	public void addPrjtAdd(SubProjectV2Dto subPrjt) {
		if(this.subPrjt == null) {
			this.subPrjt = new ArrayList<SubProjectV2Dto>();
		}
	...
	public List<SubProjectV2Dto> getSubPrjt() {
		return subPrjt;
	}
	...
	public void setSubPrjt(List<SubProjectV2Dto> subPrjt) {
	...
	public void setFirstAdtYn(CamelMap firstAdtYn) {
	...
	public void setMinMaxYn(CamelMap minMaxYn) {
